"use strict";
(self["webpackChunkPixelDo"] = self["webpackChunkPixelDo"] || []).push([["domValues"],{
...
/* harmony import */ var _assets_plus_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/plus.svg */ "./src/modules/assets/plus.svg");
/* harmony import */ var _taskListHandler_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskListHandler.js */ "./src/modules/taskListHandler.js");
/* harmony import */ var _assets_delete_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./assets/delete.svg */ "./src/modules/assets/delete.svg");
/* harmony import */ var _assets_close_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./assets/close.svg */ "./src/modules/assets/close.svg");
/* harmony import */ var _assets_project_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./assets/project.svg */ "./src/modules/assets/project.svg");
...
const displayController = (function () {
    ...
    const addTaskDisplay = function () {
        ...
        taskForm.addEventListener('submit', function (event) {
            ...
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTask(taskTitle.value, returnDate, _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].getCurrentProject(), returnIsComplete);

            taskTitle.value = '';
            taskDate.value = '';
            reloadAddTaskButton();
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].loopTasks();
        });
    ...
    const reloadAddTaskButton = function () {
        const taskDiv = document.querySelector('.task-div');
        taskDiv.innerHTML = `<button class="add-task"><img src="${_assets_plus_svg__WEBPACK_IMPORTED_MODULE_1__}">Add Task</button>`;
        addTaskTrigger();
    }
    ...
    const displayPendingTasks = function (task, index) {
        ...
        pendingItemDiv.innerHTML = `<div class="pending-toggler"><div></div></div><p>${returnTitle}</p><p>${returnDate}</p><img class="task-delete-button" src="${_assets_delete_svg__WEBPACK_IMPORTED_MODULE_3__}">`;
        ...
        pendingItemDiv.addEventListener('click', function (event) {
            if (event.target.classList.contains('task-delete-button')) {
                _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask(index);
                _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].loopTasks();
            }
        });
    }
    ...
    const displayCompletedTasks = function (task, index) {
        ...
        completedItemDiv.innerHTML = `<div class="completed-toggler"><div></div></div><p>${returnTitle}</p><p>${returnDate}</p><img class="task-delete-button" src="${_assets_delete_svg__WEBPACK_IMPORTED_MODULE_3__}">`;

        completedItemDiv.addEventListener('click', function () {
            task.setIsComplete(false);
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].loopTasks();  // Update the task display
        });
    ...
    const addProjectDisplay = function () {
        ...
        projectForm.addEventListener('submit', function (event) {
            ...
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].addNewProject(projectTitle.value);

            projectTitle.value = '';
            reloadAddProjectButton();
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].loopProjects();
        });
    ...
    const reloadAddProjectButton = function () {
        const projectDiv = document.querySelector('.project-div');
        projectDiv.innerHTML = `<button class="add-project"><img src="${_assets_plus_svg__WEBPACK_IMPORTED_MODULE_1__}">Add Project</button>`;
        addProjectTrigger();
    }
    ...
    const displayProjects = function (projectTitle, index) {
        ...
        newProjectItem.innerHTML = `<img class="project-logo" src="${_assets_project_svg__WEBPACK_IMPORTED_MODULE_5__}"><p>${projectTitle}</p><img class="close-button" src="${_assets_close_svg__WEBPACK_IMPORTED_MODULE_4__}">`;
        ...
        newProjectItem.addEventListener('click', function (event) {
            ...
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentProject(projectTitle);
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentFilter("project");
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].loopTasks();
        });
    }
    ...
    const setToolSelector = function () {
        ...
        inboxButton.addEventListener('click', () => {
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentProject("default");
            removeSelectedId();
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentFilter("inbox");
        ...
        todayButton.addEventListener('click', () => {
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentProject("default");
            removeSelectedId();
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentFilter("today");
        ...
        thisWeekButton.addEventListener('click', () => {
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentProject("default");
            removeSelectedId();
            _logic_js__WEBPACK_IMPORTED_MODULE_0__["default"].setCurrentFilter("this-week");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _taskListHandler_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskListHandler.js */ "./src/modules/taskListHandler.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/startOfDay.mjs");
...
const todoLogic = (function () {
    ...
    const addTask = function (title, date, project, isComplete) {
        const newTask = new _taskListHandler_js__WEBPACK_IMPORTED_MODULE_0__["default"](title, date, project, isComplete);
        taskList.push(newTask);
        taskList.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.compareAsc)(new Date(a.getDate()), new Date(b.getDate())));
    ...
    function isThisWeek(date) {
        const now = new Date();
        const start = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.startOfWeek)(now, { weekStartsOn: 1 }); // week starts on Monday
        const end = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.endOfWeek)(now, { weekStartsOn: 1 }); // week ends on Sunday

        return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.isWithinInterval)(date, { start, end });
    }
    ...
    const loopTasks = function () {
        ...
        taskList.forEach(function (task, index) {
            ...
            const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.startOfDay)(new Date(`${month}/${day}/${year}`));

            if (getCurrentFilter() === "inbox") {
                if (task.getIsComplete()) {
                    _domValues_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayCompletedTasks(task, index);
                } else {
                    _domValues_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayPendingTasks(task, index);
                }
            } else if (currentFilter === "today") {
                if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__.isToday)(taskDate)) {
                    if (task.getIsComplete()) {
                        _domValues_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayCompletedTasks(task, index);
                    } else {
                        _domValues_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayPendingTasks(task, index);
    ...
    const loopProjects = function () {
        ...
        projectsList.forEach(function (projectTitle, index) {
            _domValues_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayProjects(projectTitle, index);
        });
    };
    ...
    const loadDataFromLocalStorage = function () {
        ...
        if (storedTaskList) {
            ...
            taskList = parsedTaskList.map(task => new _taskListHandler_js__WEBPACK_IMPORTED_MODULE_0__["default"](task.title, task.date, task.projectGroup, task.isComplete));
        }
...
/***/ "./src/modules/taskListHandler.js":
/*!****************************************!*\
  !*** ./src/modules/taskListHandler.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function Task(title, date, projectGroup, isComplete) {
    ...
    if (date === "") {
        ...
        this.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(), 'dd/MM/yyyy');
    } else {
        // Parse the date string into a Date object and format it
        this.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(date, 'dd/MM/yyyy', new Date()), 'dd/MM/yyyy');
    }
    ...
    this.setDate = function (newDate) {
        this.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(newDate, 'dd/MM/yyyy', new Date()), 'dd/MM/yyyy');
    }
...
function parse(dateStr, formatStr, referenceDate, options) {
  ...
  for (let token of tokens) {
    if (
      ...
      (0,_lib_protectedTokens_mjs__WEBPACK_IMPORTED_MODULE_6__.warnOrThrowProtectedError)(token, formatStr, dateStr);
    }
    if (
      !options?.useAdditionalDayOfYearTokens &&
